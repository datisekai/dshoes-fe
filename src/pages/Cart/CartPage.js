...
import { decreaseCart, increaseCart, removeProduct } from "../../redux/cartReducer";
    ...
    <>
      ...
      <div className="min-h-screen relative bg-[#222222]">
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row p-5">
          <Bag carts={carts} handleAdd={handleAdd} handleMinus={handleMinus} handleDelete={handleDelete}/>
          <Sumary />
        </div>
